pipeline {
    ...
    environment{
        ...
        PORT = 19205
        PROJECT_NAME="docker_mse_iged_api_utilitario"
    ...
    stages {
        ...
        steps {
            script{
                ...
                remote.fileTransfer = "sftp"
                sshCommand remote: remote, command: "docker run -d -it --rm --network net.1 --name ${PROJECT_NAME} -p ${PORT}:19212 ${PROJECT_NAME}"
            }  
        }
        }
    }
